...
#        py是对windows操作系统的，OS X直接./即可
# Extension: py mcb.pyw delete <keyword> - 删除关键字<keyword>
...
if len(sys.argv) == 3 and sys.argv[1].lower() == 'save':     # argv第一个参数[0]是文件名，接着是后续跟着的参数
...
elif len(sys.argv) == 3 and sys.argv[1].lower() == 'delete':    # 删除指定关键字
    ...
    if sys.argv[1].lower() == 'list':
        ...
        for i in mcbShelf.keys():           # 删除所有关键字
            del mcbShelf[i]
mcbShelf.close()
